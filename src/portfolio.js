...
function runSync(){
  ...
  setTimeout(()=>{
    ...
    map.innerHTML = `<div class="row"><span>Opportunity: "Bulk export API"</span><span>-> Feature note created</span></div>
                      <div class="row"><span>Stage: Discovery</span><span>-> Priority: Medium</span></div>`;
  }, 1100);
  setTimeout(()=>{
